...
module.exports = {
  ...
  rules: {
    ...
    // coderwyd
    'coderwyd/generic-spacing': 'error',
    'coderwyd/no-cjs-exports': 'error',
    'coderwyd/no-ts-export-equal': 'error',
    'coderwyd/no-const-enum': 'error',
    'coderwyd/named-tuple-spacing': 'error',
